              ...
              {showNotifPanel && (
                <div className="absolute right-0 top-12 w-80 bg-white border border-slate-200 rounded-2xl shadow-2xl z-[9999] overflow-hidden">
                  ...
                  <div className="px-4 py-2 bg-slate-50 border-t border-slate-200">
                    <button data-action-bound="true" onClick={(e) => { e.stopPropagation(); setShowNotifPanel(false); }} className="w-full text-center text-[10px] font-bold text-emerald-600 hover:text-emerald-700 py-1">Dismiss All</button>
                  </div>
                </div>
              )}
            </div>
