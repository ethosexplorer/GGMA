    ...
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      ...
      <header className="px-8 py-6 flex justify-between items-center border-b border-slate-200/50 bg-white sticky top-0 z-10 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:block">
            <span className="font-black text-xl text-slate-800 tracking-tight block">GGHP Legal Intake</span>
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto p-6 md:p-12">
        <div className="mb-10 text-center">
          <h1 className="text-4xl font-black text-slate-800 tracking-tight mb-4">Legal Intake</h1>
