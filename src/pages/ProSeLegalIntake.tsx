      ...
      <main className="flex-1 max-w-4xl w-full mx-auto p-6 md:p-12">
        <div className="mb-10 text-center">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto">
            The legal system weaponizes procedure against those fighting for the truth. Our Pro Se Advocacy program is designed to level the playing field, expose attorney misconduct, and prepare you to represent yourself effectively. 
          </p>
        </div>
