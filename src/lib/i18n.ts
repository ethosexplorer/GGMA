...
const TRANSLATIONS: Record<string, Translations> = {
  en: {
    ...
    'footer.support': 'Support: 1-888-963-4447 | Admin: asstsupport@gmail.com',
  ...
  es: {
    ...
    'footer.support': 'Soporte: 1-888-963-4447',
  ...
  zh: {
    ...
    'footer.support': '支持热线: 1-888-963-4447',
    'common.language': '语言',
  ...
  vi: {
    ...
    'footer.support': 'Hỗ Trợ: 1-888-963-4447',
  ...
  ko: {
    ...
    'footer.support': '지원: 1-888-963-4447',
    'common.language': '언어',
  ...
  ar: {
    ...
    'footer.support': 'الدعم: 1-888-963-4447',
