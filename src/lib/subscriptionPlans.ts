...
export const PUBLIC_HEALTH_PLANS: SubscriptionPlan[] = [
  {
    ...
    monthlyPrice: 149,
    annualPrice: 1499,
    aiLevel: 'Sylara AI: Lab Workflow Guidance',
    bestFor: 'Single-location labs, small health depts, researchers',
    trialDays: 30,
    trialPrice: 0,
    tokensMonth: '500,000 tokens/mo',
    features: [
      'Basic accreditation tracking & renewal alerts',
      'COA (Certificate of Analysis) management',
      'Single-lab contaminant monitoring dashboard',
      'Basic patient outcome data (de-identified)',
      'Standard compliance reporting',
      'Sylara AI: Lab workflow guidance',
  ...
  },
  {
    ...
    monthlyPrice: 499,
    annualPrice: 4999,
    aiLevel: 'Full Sylara + L.A.R.R.Y. Lab Enforcement',
    bestFor: 'Multi-location labs, state health agencies, hospital networks',
    trialDays: 30,
    trialPrice: 0,
    tokensMonth: '2,000,000 tokens/mo',
    features: [
      'Everything in Lab Essentials',
      'Multi-lab oversight (up to 10 locations)',
      'Advanced contaminant trending & anomaly detection',
      'Patient outcome correlation analytics',
      'Product recall management & alert system',
      'L.A.R.R.Y. Lab Enforcement: auto-flag testing anomalies',
      'Outbreak & contamination mapping',
      'Research data export & API access',
  ...
  {
    id: 'ph_enterprise',
    name: 'Lab Command Center',
    monthlyPrice: 999,
    annualPrice: 9999,
    aiLevel: 'Unlimited AI + Custom Models + Strategy Reviews',
    bestFor: 'State regulators, pharma, MSOs, national lab chains',
    trialDays: 30,
    trialPrice: 0,
    tokensMonth: 'Unlimited tokens/mo',
    features: [
      'Everything in Lab Intelligence',
      'Unlimited lab locations',
      'Statewide/national contamination surveillance',
      'Recency Index integration for impairment science',
      'Policy impact modeling for testing standards',
      'Cross-state lab result comparison & harmonization',
      'FDA/USDA/DEA reporting automation',
      'Custom AI models trained on your testing data',
...
export const PUBLIC_HEALTH_ADDONS: AddOn[] = [
  ...
  { id: 'ph_add_risk_monitor', name: 'Risk & Contaminant Monitoring (Advanced)', price: 149 },
  { id: 'ph_add_research', name: 'Research & Analytics Tools', price: 89 },
  { id: 'ph_add_multi_lab', name: 'Multi-Lab / Multi-Jurisdiction Oversight', price: 199 },
  { id: 'ph_add_ai_safety', name: 'Premium AI Safety Guidance (Sylara Lab)', price: 54.99, per: 'unlimited tokens' },
  { id: 'ph_add_reporting', name: 'Reporting & Partnership Tools', price: 49 },
  { id: 'ph_add_recency', name: 'Recency Index Module', price: 299 },
  { id: 'ph_add_outbreak', name: 'Outbreak Detection & Mapping', price: 179 },
  { id: 'ph_add_lims', name: 'LIMS Integration Connector', price: 149, per: 'per LIMS system' },
];
