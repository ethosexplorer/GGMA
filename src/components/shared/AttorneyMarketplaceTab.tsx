...
export const AttorneyMarketplaceTab = () => {
  ...
  const attorneys = [
    {
      id: 'ATY-001',
      name: 'Sarah Lee Gossett Parrish',
      firm: 'OK Cannabis Law Office',
      ...
      status: 'Online Now',
      bio: 'Expert in Oklahoma cannabis law. Successfully managed over 200 commercial license applications and compliance matters.',
      verified: true
    },
    {
      id: 'ATY-002',
      name: 'Stephen Cale',
      firm: 'Tulsa Medical Marijuana Lawyer',
      location: 'Tulsa, OK',
      specialties: ['Criminal Defense', 'OMMA Appeals', 'Business Structuring'],
      rating: 4.8,
      reviews: 89,
      image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=200&h=200',
      status: 'Busy',
      bio: 'Specializing in OMMA administrative appeals and criminal defense related to the Oklahoma Medical Marijuana Authority.',
      verified: true
    },
    {
      id: 'ATY-003',
      ...
      firm: 'Gies Law Firm',
      location: 'Oklahoma City, OK',
      specialties: ['Corporate Governance', 'M&A', 'Tax (280E)'],
      rating: 5.0,
      reviews: 215,
      image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=200&h=200',
      status: 'Online Now',
      bio: 'Protecting patient rights and navigating restrictive medical programs. Strategic tax planning and IP protection.',
      verified: true
    },
    {
      id: 'ATY-004',
      name: 'Overman Legal Group',
      firm: 'Overman Legal Group',
      location: 'Oklahoma City, OK',
      specialties: ['Dispensary Licensing', 'IP Protection', 'Employment Law'],
      rating: 4.7,
      reviews: 56,
      image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=200&h=200',
      status: 'Away',
      bio: 'Strategic planning and business defense for dispensaries, growers, and processors in Oklahoma.',
      verified: true
    }
  ];
          ...
          {attorneys.filter(atty => 
            ...
            <div key={atty.id} className="bg-white rounded-[2.5rem] border border-slate-200 p-6 hover:shadow-2xl hover:border-emerald-500/30 transition-all group relative flex flex-col md:flex-row gap-6">
               ...
               <div className="flex-1">
                  ...
                  <div className="flex gap-2">
                    <a 
                      href="https://calendly.com/globalgreenhpmeet/legal-consultation" 
                      target="_blank" 
                      ...
                      className="flex-1 flex items-center justify-center gap-2 py-3 bg-[#1a4731] text-white rounded-2xl text-xs font-black hover:bg-[#153a28] shadow-lg shadow-emerald-900/20 transition-all"
                    >
                       <MessageSquare size={16} /> Consult Now
                    </a>
                    <button onClick={() => { import('../../lib/turso').then(function(m) { m.turso.execute({ sql: 'INSERT INTO audit_logs (id, action, user_id, data) VALUES (?, ?, ?, ?)', args: ['log-' + Math.random().toString(36).substr(2, 9), 'UI_Action', 'Production_User', JSON.stringify({ detail: 'Action executed' })] }).catch(function(e) { console.error(e) }) }) }} className="px-4 py-3 bg-white border border-slate-200 rounded-2xl text-slate-700 hover:bg-slate-50 transition-all">
                       <FileText size={18} />
                    </button>
                  </div>
               </div>
