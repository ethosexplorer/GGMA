    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm relative overflow-hidden group">
          ...
          <p className="text-[10px] text-slate-500 leading-tight">
            <strong>Stripe Processing:</strong> Connected via secure Stripe Payment Rail. Direct bank-to-ecosystem bridge active.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <div className="bg-blue-900 bg-gradient-to-br from-blue-900 to-indigo-900 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
              ...
              <p className="text-sm text-blue-100/80 mb-6">Settling B2B invoices via Stripe Connect reduces transaction costs by 85% compared to traditional banking.</p>
