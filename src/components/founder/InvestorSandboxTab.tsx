...
import { MonitorPlay, Building2, HeartPulse, ShieldAlert, Stethoscope, Scale, Gavel } from 'lucide-react';
import { cn } from '../../lib/utils';

export const InvestorSandboxTab = () => {
  const [activeMock, setActiveMock] = useState<'patient' | 'business' | 'provider' | 'attorney' | 'oversight' | 'none'>('none');
    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <button 
          ...
          className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-slate-800 transition-all group text-left relative overflow-hidden flex flex-col lg:col-span-2"
        >
