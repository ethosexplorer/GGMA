...
export const GlobalSweepTab = () => {
  ...
  const baseStates = [
    // Tier 1 — Mature legal markets (rec + med)
    ...
    { code: 'MN', name: 'Minnesota (OCM)', status: 'Active' },
    { code: 'DE', name: 'Delaware (OML)', status: 'Active' },
    ...
    { code: 'VA', name: 'Virginia (ABC)', status: 'Active' },
    { code: 'HI', name: 'Hawaii (DOH)', status: 'Active' },
    // Tier 2 — Medical-only or limited programs
    { code: 'FL', name: 'Florida (OMMU)', status: 'Active' },
    { code: 'PA', name: 'Pennsylvania (DOH)', status: 'Active' },
    { code: 'ND', name: 'North Dakota (NDDOH)', status: 'Active' },
    { code: 'SD', name: 'South Dakota (DOH)', status: 'Active' },
    { code: 'AR', name: 'Arkansas (ABC)', status: 'Active' },
    { code: 'LA', name: 'Louisiana (LDAF)', status: 'Active' },
    { code: 'MS', name: 'Mississippi (MDOH)', status: 'Active' },
    { code: 'AL', name: 'Alabama (AMCC)', status: 'Active' },
    { code: 'KY', name: 'Kentucky (KOHS)', status: 'Active' },
    { code: 'WV', name: 'West Virginia (DHHR)', status: 'Active' },
    { code: 'NH', name: 'New Hampshire (DHHS)', status: 'Active' },
    { code: 'UT', name: 'Utah (UDAF)', status: 'Active' },
    // Tier 3 — No program or CBD-only
    { code: 'TX', name: 'Texas (DSHS)', status: 'Planned' },
    { code: 'GA', name: 'Georgia (GPC)', status: 'Planned' },
    { code: 'NC', name: 'North Carolina', status: 'Planned' },
    { code: 'SC', name: 'South Carolina', status: 'Planned' },
    { code: 'TN', name: 'Tennessee', status: 'Planned' },
    { code: 'IN', name: 'Indiana', status: 'Planned' },
    { code: 'IA', name: 'Iowa (IDPH)', status: 'Planned' },
    { code: 'KS', name: 'Kansas', status: 'Planned' },
    { code: 'NE', name: 'Nebraska', status: 'Planned' },
    { code: 'WI', name: 'Wisconsin', status: 'Planned' },
    { code: 'WY', name: 'Wyoming', status: 'Planned' },
    { code: 'ID', name: 'Idaho', status: 'Planned' },
