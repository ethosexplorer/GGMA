...
export const GlobalSweepTab = () => {
  ...
  const baseStates = [
    ...
    { code: 'AR', name: 'Arkansas — Medical Only (Capped Licenses)', status: 'Active', scraper: 'Built' },
    { code: 'CA', name: 'California — Rec + Medical (Dual Licensing)', status: 'Active', scraper: 'Built' },
