...
const getFullStateName = (s: string): string => {
                          ...
                          <div className="bg-gradient-to-r from-indigo-50 to-slate-50 border border-indigo-200/60 rounded-xl p-3 mb-2">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  <input type={showGgpPw ? 'text' : 'password'} value={editData.ggpLoginPassword !== undefined ? editData.ggpLoginPassword : (r.rawData?.ggpLoginPassword || (getFullStateName(r.state) + '1'))} onChange={(e) => setEditData(prev => ({ ...prev, ggpLoginPassword: e.target.value }))} className="w-full px-3 py-2 pr-8 border border-slate-200 rounded-lg text-sm font-medium outline-none focus:border-indigo-500 bg-white font-mono" />
                          ...
                          <div className="bg-gradient-to-r from-amber-50 to-slate-50 border border-amber-200/60 rounded-xl p-3 mb-2">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div>
                                ...
                                <input type="text" value={editData.statePortalLogin !== undefined ? editData.statePortalLogin : (r.rawData?.statePortalLogin || r.email || '')} onChange={(e) => setEditData(prev => ({ ...prev, statePortalLogin: e.target.value }))} className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm font-medium outline-none focus:border-amber-500 bg-white" placeholder="State portal username" />
                              </div>
                              <div>
                                <label className="text-[9px] font-bold text-slate-500 block mb-1">Password</label>
                                <div className="relative">
                                  <input type={showStatePw ? 'text' : 'password'} value={editData.statePortalPassword !== undefined ? editData.statePortalPassword : (r.rawData?.statePortalPassword || (getFullStateName(r.state) + '1'))} onChange={(e) => setEditData(prev => ({ ...prev, statePortalPassword: e.target.value }))} className="w-full px-3 py-2 pr-8 border border-slate-200 rounded-lg text-sm font-medium outline-none focus:border-amber-500 bg-white font-mono" />
