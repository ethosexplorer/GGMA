...
const data: StateData[] = [
  ...
  { id: "12", state: "Florida", status: "medical_only", dispensaries: 630, note: "Medical cannabis legal since 2016" },
  ...
  { id: "20", state: "Kansas", status: "illegal", dispensaries: 0, note: "Cannabis fully illegal" },
