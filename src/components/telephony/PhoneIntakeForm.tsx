    ...
    try {
      ...
      try {
        ...
        await captureContact({
          ...
          zip: data.zip,
          contactType: isPatientIntake ? 'patient' : intakeType === 'cannacribs_application' ? 'cannacribs' : 'business_owner',
          source: isPatientIntake ? 'phone_intake_patient' : intakeType === 'cannacribs_application' ? 'cannacribs_application' : 'phone_intake_business',
    ...
    try {
      ...
      try {
        await captureContact({
          ...
          state: data.state || '',
          zip: '',
          contactType: intakeType === 'patient_card' ? 'patient' : intakeType === 'cannacribs_application' ? 'cannacribs' : 'business_owner',
          source: intakeType === 'cannacribs_application' ? 'cannacribs_application' : 'phone_intake_lead',
          businessName: '',
