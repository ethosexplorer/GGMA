            ...
            <div className="bg-[#1a4731] rounded-2xl p-6 text-white shadow-lg shadow-emerald-900/10">
               ...
               <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <button 
                      onClick={() => ((window as any).Calendly ? (window as any).Calendly.initPopupWidget({ url: 'https://calendly.com/globalgreenenterprize/15min' }) : window.open('https://calendly.com/globalgreenenterprize/15min', '_blank'))}
