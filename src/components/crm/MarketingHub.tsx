...
export const MarketingHub = () => {
  ...
  useEffect(() => {
    const seedValuationTemplates = async () => {
      try {
        ...
        const cta = `<div style="text-align: center; margin: 32px 0;"><a href="${VALUATION_URL}" target="_blank" rel="noopener noreferrer" style="display: inline-block; background: linear-gradient(135deg, #0A3D2A, #134D36); color: #E8D5B5; padding: 16px 44px; border-radius: 12px; font-weight: 800; text-decoration: none; font-size: 14px;">View the Full Valuation Brief</a></div>`;
  ...
  <div style="text-align: center; margin: 32px 0;">
    <a href="https://globalgreenhp.com/GGHP_Agency_Valuation_Brief.html" target="_blank" rel="noopener noreferrer" style="display: inline-block; background: linear-gradient(135deg, #0A3D2A, #134D36); color: #E8D5B5; padding: 16px 44px; border-radius: 12px; font-weight: 800; text-decoration: none; font-size: 14px; letter-spacing: 0.5px;">View the Full Valuation Brief</a>
  </div>
