...
const LANDMARK_CASES = [
  ...
  {
    title: 'Standing Akimbo LLC v. United States (SCOTUS 2021)',
    court: 'U.S. Supreme Court',
    status: 'Cert Denied (Thomas Dissent)',
    outcome: 'Mixed',
    summary: 'Tax case where Justice Thomas wrote a scathing dissent calling federal cannabis enforcement "a half-in, half-out regime that simultaneously tolerates and forbids." Signaled SCOTUS appetite for reform.',
    impact: 'High',
    date: '2021',
    tags: ['SCOTUS', 'Thomas Dissent', '280E', 'Federal Inconsistency'],
  },
  {
    title: 'United States v. Marin Alliance (9th Cir. 2015)',
    court: '9th Circuit Court of Appeals',
    status: 'Precedent Set',
    outcome: 'Favorable',
    summary: 'Ninth Circuit ruled the Rohrabacher-Farr amendment bars DOJ from spending funds to prosecute state-compliant dispensaries. Strengthened McIntosh.',
    impact: 'High',
    date: '2015',
    tags: ['9th Circuit', 'Appropriations', 'Dispensary Protection'],
  },
  {
    title: 'United States v. Pickard (10th Cir. 2021)',
    court: '10th Circuit Court of Appeals',
    status: 'Decided',
    outcome: 'Favorable',
    summary: 'Tenth Circuit ruled that CBD products derived from legal hemp are not controlled substances. Key distinction between hemp and marijuana.',
    impact: 'Moderate',
    date: '2021',
    tags: ['10th Circuit', 'CBD', 'Hemp', 'Farm Bill'],
  },
  {
    title: 'Boidi v. Cnty. of Butte (9th Cir. 2022)',
    court: '9th Circuit Court of Appeals',
    status: 'Decided',
    outcome: 'Unfavorable',
    summary: 'Upheld county-level cannabis bans even in states with legalization. Counties retain local control over cultivation and sales.',
    impact: 'Moderate',
    date: '2022',
    tags: ['9th Circuit', 'Local Control', 'County Bans'],
  },
  {
    title: 'Harborside Health Center v. City of San Jose (Cal. Supreme 2018)',
    court: 'California Supreme Court',
    status: 'Decided',
    outcome: 'Favorable',
    summary: 'Ruled that cities cannot impose punitive taxes specifically targeting legal cannabis businesses beyond standard business taxation.',
    impact: 'High',
    date: '2018',
    tags: ['State Supreme Court', 'Taxation', 'Equal Protection'],
  },
];
...
const JUDICIAL_PROFILES = [
  ...
  },
  {
    ...
    court: 'U.S. Supreme Court',
    stance: 'States\' Rights',
    note: 'Strong federalism advocate. Has consistently argued states should be free to serve as "laboratories of democracy" on issues like cannabis policy.',
    cases: 2,
    color: 'blue',
  },
  {
    ...
    court: 'U.S. Supreme Court',
    stance: 'Reform-Leaning',
    note: 'Has written extensively on racial disparities in drug enforcement. Questioned the constitutionality of disproportionate sentencing for cannabis possession.',
    cases: 5,
    color: 'emerald',
  },
  {
    name: 'Chief Judge Sidney Thomas',
    court: '9th Circuit Court of Appeals',
    stance: 'Pro-Reform',
    note: 'Authored the McIntosh decision protecting state-legal operations from federal prosecution. Landmark ruling still cited in cannabis defense nationally.',
    cases: 18,
    color: 'emerald',
  },
  {
    name: 'Judge Timothy Tymkovich',
    court: '10th Circuit Court of Appeals',
    stance: 'Moderate',
    note: 'Presided over Safe Streets Alliance. While cautious, his rulings have consistently upheld state sovereignty in cannabis regulation.',
    cases: 9,
    color: 'amber',
  },
  {
    name: 'Judge Merrick Garland (Former)',
    court: 'D.C. Circuit / Former AG',
    stance: 'Institutional Reform',
    note: 'As AG, deprioritized federal cannabis prosecution. D.C. Circuit opinions emphasized regulatory pragmatism over criminalization.',
    cases: 7,
    color: 'blue',
  },
  {
    name: 'Judge Carlton Reeves',
    court: 'S.D. Mississippi',
    stance: 'Pro-Reform',
    note: 'Has called the War on Drugs "the new Jim Crow" from the bench. Advocates for sentencing reform and judicial education on cannabis science.',
    cases: 11,
    color: 'emerald',
  },
];
...
const ACTIVE_CASES = [
  ...
  {
    title: 'Multi-State Operators v. DEA (D.C. Circuit)',
    court: 'D.C. Circuit Court of Appeals',
    type: 'Interstate Commerce',
    status: 'Active',
    nextHearing: 'May 20, 2026',
    summary: 'Challenge to federal ban on interstate cannabis transport post-rescheduling. If successful, would enable cross-state supply chains for licensed operators.',
  },
  {
    title: 'SCOTUS — Petition: Cannabis Workers United v. Amazon',
    court: 'U.S. Supreme Court',
    type: 'Employment Rights',
    status: 'Cert Petition Filed',
    nextHearing: 'Conference: May 15, 2026',
    summary: 'Whether employers can terminate employees for off-duty medical cannabis use in states with patient protections. Could establish nationwide employment precedent.',
  },
];
