...
export const RoleSelectorScreen = ({ userProfile, onSelect, onLogout, onHome }: { userProfile: any, onSelect: (role: string) => void, onLogout?: () => void, onHome?: () => void }) => {
  ...
  const allRoles = [
    ...
    { id: 'admin_internal', label: 'Internal Team (Management)', desc: 'Onboarding, Monitoring, Analytics & Support', icon: Briefcase, color: 'teal' },
    { id: 'operations', label: 'Operations Admin (Staff View)', desc: 'Call Center, Phone Intake, Scheduling & Support', icon: Headset, color: 'cyan' },
