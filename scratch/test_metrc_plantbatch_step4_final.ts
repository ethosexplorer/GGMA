...
async function destroyPlantBatchStep4Final() {
  ...
  try {
    console.log(`Running PlantBatches Step 4 (Destroy Batch ${batchName}) with exact documented fields...`);
    
    // v2 destroy uses 'PlantBatch', 'Count', 'WasteReasonName', 'ReasonNote', 'WasteWeight', 'WasteUnitOfMeasure'
    const body = [{
