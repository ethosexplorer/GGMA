...
async function destroyPlantBatchStep4Corrected() {
  ...
  try {
    console.log(`Running PlantBatches Step 4 (Destroy Batch ${batchName}) with corrected fields...`);
    
    // v2 destroy uses 'Name', 'Count', 'WasteReasonName', 'WasteWeight', and 'Note'
    const body = [{
      Name: batchName,
      Count: 3,
      WasteReasonName: "Damage/Spoilage",
      WasteWeight: 1.0,
      Note: "Technical Evaluation Test",
...
destroyPlantBatchStep4Corrected();
