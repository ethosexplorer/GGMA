...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Fetch live content with Chrome user-agent
    ...
    for (const block of textBlocks) {
      ...
      // Filter out non-recall/embargo descriptions
      ...
      // Standardize/Clean business name
      ...
      // Deduplicate and merge key details if duplicate is found
